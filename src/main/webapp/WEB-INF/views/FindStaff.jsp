...
<body>
	...
	<form action="${pageContext.request.contextPath}/staff/findStaff"
		method="get">
		<h1>Find Staff</h1>
		<h3>${errorMessage}</h3>
		<br> Staff Name <input type="text" name="staffName"> <br>
		Staff Email <input type="text" name="staffEmail"> <input
			type="submit" value="Find"> <br> <a
	...
	<table cellpadding="6px" bordercolor="black">
		...
		<c:forEach items="${staffs}" var="staff">
			...
			<tr id="tr{staff.id}">
				...
				<td><input onclick="update(${staff.id})" type="submit"
					value="Update"></td>
				<td id="td${staff.id}"><input
